...
const About = () => {
    ...
    useGSAP(()=>{
        ...
        const aboutText = new SplitText('.about-para', {
            type: "words"
        })
        ...
        aboutImgTL.from('.about_image_section', {
            x: "-150%",
            duration: 1,
            ease: "power1.inOut",
        }).to('.overlay', {
    ...
    return (
        <section className="about h-screen w-full md:p-4 text-center flex flex-col md:flex-row md:gap-4">
